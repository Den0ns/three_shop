<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"F:\web\WWW\three_shop\public/../application/admin\view\advert\advert_add.html";i:1524488999;}*/ ?>
...
<div class="main-div">
<form action="<?php echo url('Advert/advert_add'); ?>" method="post" enctype="multipart/form-data">
  <table width="100%" id="general-table">
    ...
    <tr>
      ...
      <td>
        <input type="radio" name="ad_status" value="1"  checked="true"  />开启    
        <input type="radio" name="ad_status" value="0"  />关闭    
      </td>
    </tr>
    <tr>
       <td class="label">&nbsp;</td>
