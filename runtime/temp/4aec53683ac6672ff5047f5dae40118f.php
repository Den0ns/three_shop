<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpStudy\WWW\PHP_13\three_shop\public/../application/admin\view\goods\goods_add.html";i:1524471793;}*/ ?>
...
<head>
	...
	<script type="text/javascript" src="/static/admin/js/selectzone.js"></script>
	<script type="text/javascript" src="/static/admin/js/colorselector.js"></script>
	<script type="text/javascript" src="/static/admin/js/calendar.php?lang="></script>
...
<body>
<h1>
	<span class="action-span"><a href="<?php echo url('Goods/goods_list'); ?>">商品列表</a></span>
    ...
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="" method="post" name="theForm"> 
          ...
          <tr>
            ...
            <td>
              <input type="file" name="goods_img" size="35">
                              <a href="goods.php?act=show_image&amp;img_url=/static/admin/images200905/goods_img/32_G_1242110760868.jpg" target="_blank"><img src="/static/admin/imagesyes.gif" border="0"></a>
          ...
          <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              <input type="file" name="goods_thumb" size="35" disabled="">
                              <a href="goods.php?act=show_image&amp;img_url=/static/admin/images200905/thumb_img/32_thumb_G_1242110760196.jpg" target="_blank"><img src="/static/admin/imagesyes.gif" border="0"></a>
        ...
        <table width="90%" id="detail-table" style="display: none;">
          <tbody><tr>
            <td><script id="editor" name="goods_desc" type="text/plain" style="width:1024px;height:500px;"></script>
          </tr>
        </tbody></table>
        ...
        <table width="90%" id="mix-table" style="display: none;" align="center">
            ...
            <td><input type="text" name="goods_weight" value="" size="20"> <select name="weight_unit"><option value="1">千克</option><option value="0.001" selected="">克</option></select></td>
                              ...
                              <tr>
            <td class="label"><a href="javascript:showNotice('noticeStorage');" title="点击此处查看提示信息"><img src="/static/admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
<!--            <td><input type="text" name="goods_number" value="4" size="20" readonly="readonly" /><br />-->
          ...
          <tr>
            <td class="label">
            <a href="javascript:showNotice('noticeSellerNote');" title="点击此处查看提示信息"><img src="/static/admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注： </td>
				...
				<tr>
					...
					<td>
						<select name="goods_type" onchange="getAttrList(32)">
							...
							<option value="9" selected="true">精品手机</option>
							<option value="10">我的商品</option>                
						</select><br>
        ...
        <table width="90%" id="gallery-table" style="display: none;" align="center">
          <tbody><tr>
            <td>
                ...
                <a href="/static/admin/images200905/goods_img/32_P_1242110760641.jpg" target="_blank">
                <img src="/static/admin/images200905/thumb_img/32_thumb_P_1242110760997.jpg" width="100" height="100" border="0">
                </a><br>
...
<script type="text/javascript" src="/static/admin/js/tab.js"></script>
