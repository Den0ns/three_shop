<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"F:\web\WWW\three_shop\public/../application/admin\view\advert\advert_updata.html";i:1524557811;}*/ ?>
...
<form action="updatas?id=<?php echo $res['ad_id']; ?>" method="post" enctype="multipart/form-data">
  <table width="100%" id="general-table">
    ...
    <tr>
      ...
      <td>
        <input type="radio" name="ad_status" <?php echo $res['ad_status']==1?'checked':''; ?>    />开启    
        <input type="radio" name="ad_status" <?php echo $res['ad_status']==0?'checked':''; ?>  />关闭    
      </td>
    </tr>
    <tr>
       <td class="label">&nbsp;</td>
       <td>
       <input type="hidden" name="ad_id"  value="<?php echo $res['ad_id']; ?>" />
       <input type="hidden" name="old_img"  value="<?php echo $res['ad_img']; ?>" />
