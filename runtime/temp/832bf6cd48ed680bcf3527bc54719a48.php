<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpStudy\WWW\three_shop\public/../application/admin\view\login\login.html";i:1525419653;}*/ ?>
<!--Author: W3layouts
	...
	<div class="main-content-agile">
		<div class="sub-main-w3">	
			...
			<form action="<?php echo url('login/login'); ?>" method="post">
				...
				<div class="pom-agile">
					<input  placeholder="Password" name="admin_pwd" class="pass" type="password" required="">
