<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\three_shop\public/../application/admin\view\cat\cat_list.html";i:1524471705;}*/ ?>
...
<h1>
<span class="action-span"><a href="<?php echo url('Cat/cat_add'); ?>">添加分类</a></span>
<span class="action-span1"><a href="<?php echo url('Index/index'); ?>">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品分类 </span>
...
<!-- start ad position list -->
			...
			<tbody>
				...
				<tr align="center" class="0" id="0_1">
					<td align="left" class="first-cell">
						<img src="/static/admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:0em" onclick="rowClicked(this)">
					...
					<td width="10%"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 1)"></td>
					<td width="10%"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 1)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_5" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 5)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 5)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_2" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 2)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 2)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_3" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 3)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 3)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_4" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 4)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 4)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_0_12" width="9" height="9" border="0" style="margin-left:0em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 12)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 12)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_15" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 15)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 15)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_13" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 13)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 13)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_14" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 14)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 14)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_0_6" width="9" height="9" border="0" style="margin-left:0em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 6)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 6)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_8" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 8)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 8)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_9" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 9)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 9)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_11" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 11)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 11)"></td>
    ...
    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255);">
            <img src="/static/admin/images/menu_minus.gif" id="icon_1_7" width="9" height="9" border="0" style="margin-left:1em" onclick="rowClicked(this)">
    ...
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', 7)"></td>
    <td width="10%" style="background-color: rgb(255, 255, 255);"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', 7)"></td>
