<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"F:\web\WWW\three_shop\public/../application/admin\view\payment\payment_add.html";i:1524660463;}*/ ?>
...
<!--遮罩-->
	<span class="action-span"><a href="<?php echo url('Payment/payment_list'); ?>">支付列表</a></span>

<span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="inion-span1"> &nbsp;&nbsp;&nbsp;&nbsp; 添加支付 </span>
...
<div class="main-div">
<form action="<?php echo url('Payment/payment_add'); ?>" method="post" enctype="multipart/form-data">
  <table width="100%" id="general-table">
    <tr>
      <td  class="label">
        <a href="javascript:showNotice('NameNotic');" title="点击此处查看提示信息">
        <img src="/static/admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>支付名称</td>
      <td>
        <input type="text" name="pay_name" value="" size="35" />
        <br /><span class="notice-span" style="display:block"  id="NameNotic">支付名称只是作为辨别多个支付方式之用</span>
      </td>
    </tr>
    <tr>
      <tbody id="0">
    <tr>
      ...
      <td>
        <textarea style="width:300px;height:100px;" name="pay_desc"></textarea>
      </td>
    </tr>
    <tr>
      <td  class="label">支付排序</td>
      <td>
    ...
    <tr>
      <td  class="label">支付是否货到付款</td>
      <td>
        <input type="radio" name="is_cod" value="1"  />开启    
        <input type="radio" name="is_cod" value="0"  />关闭    
      </td>
    </tr>
        <tr>
      <td  class="label">支付是否在线支付</td>
      <td>
        <input type="radio" name="is_online" value="1"   />开启    
        <input type="radio" name="is_online" value="0"  />关闭    
      </td>
    </tr>
    <tr>
       <td class="label">&nbsp;</td>
