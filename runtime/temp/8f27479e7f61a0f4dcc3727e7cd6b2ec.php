<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\WWW\PHP_13\three_shop\public/../application/admin\view\user\user_add.html";i:1524712314;}*/ ?>
...
<form method="post" action="<?php echo url('User/user_add'); ?>" name="theForm" onsubmit="return validate()">
<table width="100%" >
  <tr>
    ...
    <td><input type="password" name="user_pwd" maxlength="20" size="20" /><span class="require-field">*</span></td>
  </tr>
        <tr>
