<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\phpStudy\WWW\three_shop\public/../application/admin\view\user\userrank_list.html";i:1524471705;}*/ ?>
...
<h1>
<span class="action-span"><a href="<?php echo url('User/userrank_add'); ?>">添加会员等级</a></span>
...
<table cellspacing='1' id="list-table">
  <tr>
    ...
    <td align="center"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_special', 1)" /></td>
    <td align="center"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_showprice', 1)" /></td>
    <td align="center">
    ...
    <td align="center"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_special', 2)" /></td>
    <td align="center"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_showprice', 2)" /></td>
    <td align="center">
    ...
    <td align="center"><img src="/static/admin/images/yes.gif" onclick="listTable.toggle(this, 'toggle_special', 3)" /></td>
    <td align="center"><img src="/static/admin/images/no.gif" onclick="listTable.toggle(this, 'toggle_showprice', 3)" /></td>
    <td align="center">
...
<div id="footer">
共执行 3 个查询，用时 0.052673 秒，Gzip 已禁用，内存占用 1.062 MB<br />
