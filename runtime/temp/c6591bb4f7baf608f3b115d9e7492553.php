<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\PHPNO.13\shop\public/../application/admin\view\index\menu.html";i:1525439278;}*/ ?>
...
<body>
	...
	<div id="main-div">
		<div id="menu-list">
			<ul id="menu-ul">
      <?php if(is_array($munu) || $munu instanceof \think\Collection || $munu instanceof \think\Paginator): $i = 0; $__LIST__ = $munu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<li class="explode" key="02_cat_and_goods" name="menu"><?php echo $vo['node_name']; ?>       
					<ul>
            <?php if(is_array($vo['son']) || $vo['son'] instanceof \think\Collection || $vo['son'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['node_status'] == 1): ?>
						  <li class="menu-item"><a href="/admin/<?php echo $v['url']; ?>" target="main-frame"><?php echo $v['node_name']; ?></a></li>	
              <?php else: ?>	
              <li></li>				  
