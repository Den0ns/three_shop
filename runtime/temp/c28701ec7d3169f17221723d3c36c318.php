<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\PHPNO.13\shop\public/../application/admin\view\index\top.html";i:1525439199;}*/ ?>
...
<div id="header-div">
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
      <?php if(!empty(session('admin_id'))){ ?> 
        <a href="javascript:;" target="main-frame" class="fix-submenu"><?php echo \think\Session::get('session_name'); ?></a>
      <?php } ?>
      <a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu">清除缓存</a>
      <a href="<?php echo url('Login/login_out'); ?>" target="_top" class="fix-submenu">退出</a>
    </div>
  </div>
</div>
</body>
