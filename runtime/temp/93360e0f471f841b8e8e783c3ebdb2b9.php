<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\phpStudy\WWW\PHP_13\three_shop\public/../application/admin\view\user\userrank_list.html";i:1524715426;}*/ ?>
...
<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
  <tr>
    <td class="first-cell" ><span><?php echo $vo['rank_name']; ?></span></td>
    <td align="right"><span><?php echo $vo['max_points']; ?></span></td>
    <td align="right"><span><?php echo $vo['min_points']; ?></span></td>
    <td align="right"><span><?php echo $vo['discount']; ?></span></td>
    <td align="center">
    <a href="<?php echo url('User/userrank_del',['rank_id'=>$vo['rank_id']]); ?>" title="移除">移除</a>
    <a href="<?php echo url('User/userrank_update',['rank_id'=>$vo['rank_id']]); ?>" title="修改">修改</a></td>
  </tr>
