<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\phpStudy\WWW\PHP_13\three_shop\public/../application/admin\view\advert\advert_add.html";i:1524471793;}*/ ?>
...
</h1><script type="text/javascript" src="/static/admin/js/calendar.php?lang=zh_cn"></script>
  ...
  <table width="100%" id="general-table">
    <tr>
      ...
      <td>
        ...
        <option value="1">banner1 [970x460]</option><option value="2">banner2 [970x460]</option><option value="3">banner3 [970x460]</option><option value="4">团购广告位 [230x206]</option><option value="5">首页广告1 [210x206]</option><option value="6">首页广告2 [210x206]</option><option value="7">首页广告3 [210x206]</option><option value="8">首页广告4 [210x206]</option><option value="9">1层左侧广告1 [230x270]</option><option value="10">1层左侧广告2 [230x95]</option><option value="11">1层左侧广告3 [230x95]</option><option value="12">1层左侧广告4 [230x95]</option><option value="13">2层左侧广告1 [230x270]</option><option value="14">2层左侧广告2 [230x270]</option><option value="15">3层左侧广告 [230x555]</option>        </select>
      </td>
    </tr>
    <tr>
      <td  class="label">开始日期</td>
      <td>
        <input name="start_time" type="text" id="start_time" size="22" value='2018-04-23' readonly="readonly" /><input name="selbtn1" type="button" id="selbtn1" onclick="return showCalendar('start_time', '%Y-%m-%d', false, false, 'selbtn1');" value="选择" class="button"/>
      </td>
    </tr>
    <tr>
      <td class="label">结束日期</td>
      <td>
        <input name="end_time" type="text" id="end_time" size="22" value='2018-05-23' readonly="readonly" /><input name="selbtn2" type="button" id="selbtn2" onclick="return showCalendar('end_time', '%Y-%m-%d', false, false, 'selbtn2');" value="选择" class="button"/>
      </td>
    </tr>
      <tbody id="0">
    <tr>
    ...
    <tr>
      <td  class="label">
        ...
        <img src="/static/admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>上传Flash文件</td>
      <td>
