<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\WWW\three_shop\public/../application/admin\view\privilege\role_list.html";i:1525405744;}*/ ?>
...
<h1>
  <span class="action-span"><a href="<?php echo url('Privilege/role_add'); ?>">添加角色</a></span>
...
<table cellspacing='1' cellpadding='3' id='list-table'>
  ...
  <?php if(is_array($role) || $role instanceof \think\Collection || $role instanceof \think\Paginator): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
      ...
      <td><?php echo $v['role_info']; ?></td>
      <td>
          <?php if($v['role_status'] == 0): ?>
             <span class="roleStatus" status="0">启用</span>
          <?php else: ?>
             <span class="roleStatus" status="1">不启用</span>
          <?php endif; ?>
      </td> 
      <td width="800px;" ><?php echo $v['node_name']; ?></td>
      <td> 
         <a href="<?php echo url('Privilege/role_node',['role_id'=>$v['role_id']]); ?>" title="分派权限">
         <img src="/static/admin/images/icon_priv.gif" border="0" height="16" width="16">
         </a>&nbsp;&nbsp;       
         <a href="<?php echo url('Privilege/delete',['role_id'=>$v['role_id']]); ?>" title="移除">
...
<div id="popMsg">   
  ...
  <tr>
    ...
    <td style="padding-top: 2px;padding-right:2px" valign="center" align="right" width="19"><span title="关闭" style="cursor: hand;cursor:pointer;color:red;font-size:12px;font-weight:bold;margin-right:4px;" onclick="Message.close()" >×</span><!-- <img title=关闭 style="cu    rsor: hand" onclick=closediv() hspace=3 src="msgclose.jpg"> --></td>
  </tr>
  <tr>
