<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\WWW\PHP_13\three_shop\public/../application/admin\view\index\menu.html";i:1524471793;}*/ ?>
			...
			<ul id="menu-ul">
              ...
              <li class="menu-item"><a href="<?php echo url('Cat/cat_list'); ?>" target="main-frame">商品分类</a></li>
				...
				<li class="collapse" key="07_content" name="menu"> 广告管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="<?php echo url('Advert/advert_list'); ?>" target="main-frame">文章列表</a></li>
					</ul>
				</li>
