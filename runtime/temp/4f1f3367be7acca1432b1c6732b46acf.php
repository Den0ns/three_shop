    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            ...
            <div class="list_c">            	
                <ul class="brand">
                	<li>
                    	<div class="img"><img src="/static/index/images/brand1.jpg" width="226" height="108" /></div>
                        <div class="name"><span><a href="<?php echo url('Brand/brand_list'); ?>">普拉达</a></span>（20）</div>
                    </li>
                    <li>
                    	<div class="img"><img src="/static/index/images/brand2.jpg" width="226" height="108" /></div>
                        <div class="name"><span><a href="<?php echo url('Brand/brand_list'); ?>">劳力士</a></span>（20）</div>
                    </li>
                    <li>
                    	<div class="img"><img src="/static/index/images/brand3.jpg" width="226" height="108" /></div>
                        <div class="name"><a href="<?php echo url('Brand/brand_list'); ?>"><span>古奇</span></a>（20）</div>
                    </li>
                    <li>
                    	<div class="img"><img src="/static/index/images/brand4.jpg" width="226" height="108" /></div>
