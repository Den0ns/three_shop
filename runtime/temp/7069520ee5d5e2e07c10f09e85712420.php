<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"F:\web\WWW\three_shop\public/../application/admin\view\index\menu.html";i:1524629916;}*/ ?>
...
<head>
	...
	<style type="text/css">
		...
		.explode {background: url(/static/admin/images/menu_minus.gif) no-repeat 0px 3px; font-weight: bold;}
		.collapse { background: url(/static/admin/images/menu_plus.gif) no-repeat 0px 3px; font-weight: bold;}
		.menu-item { background: url(/static/admin/images/menu_arrow.gif) no-repeat 0px 3px; font-weight: normal;}
	...
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="/static/admin/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
			</span>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="<?php echo url('Goods/goods_list'); ?>" target="main-frame">商品列表</a></li>
						  <li class="menu-item"><a href="<?php echo url('Goods/goods_add'); ?>" target="main-frame">添加新商品</a></li>
              <li class="menu-item"><a href="<?php echo url('Cat/cat_list'); ?>" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="<?php echo url('Attribute/attribute_list'); ?>" target="main-frame">商品属性</a></li>
						  <li class="menu-item"><a href="<?php echo url('Brand/brand_list'); ?>" target="main-frame">商品品牌</a></li>
						  <li class="menu-item"><a href="<?php echo url('Goodstype/goodstype_list'); ?>" target="main-frame">商品类型</a></li>
					</ul>
				</li>
				<li class="explode" key="04_order" name="menu"> 订单管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="<?php echo url('Order/order_list'); ?>" target="main-frame">订单列表</a></li>
						<!-- <li class="menu-item"><a href="order.php?act=order_query" target="main-frame">订单查询</a></li> -->
						<li class="menu-item"><a href="<?php echo url('Order/order_shopping'); ?>" target="main-frame">发货单列表</a></li>
						<li class="menu-item"><a href="<?php echo url('Order/order_return'); ?>" target="main-frame">退货单列表</a></li>
					</ul>
				</li>
				<li class="collapse" key="07_content" name="menu"> 广告管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="<?php echo url('Advert/advert_list'); ?>" target="main-frame">广告列表</a></li>
					</ul>
				</li>
        <li class="collapse" key="07_content" name="menu"> 支付管理        
          <ul style="display: block;">
            <li class="menu-item"><a href="<?php echo url('Payment/payment_list'); ?>" target="main-frame">支付列表</a></li>
          </ul>
        </li>
				<li class="explode" key="08_members" name="menu"> 会员管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="<?php echo url('User/user_list'); ?>" target="main-frame">会员列表</a></li>
						<li class="menu-item"><a href="<?php echo url('User/user_add'); ?>" target="main-frame">添加会员</a></li>
						<li class="menu-item"><a href="<?php echo url('User/userrank_list'); ?>" target="main-frame">会员等级</a></li>
					</ul>
				</li>
				<li class="collapse" key="10_priv_admin" name="menu"> 权限管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="<?php echo url('Privilege/privilege_list'); ?>" target="main-frame">管理员列表</a></li>
						<li class="menu-item"><a href="<?php echo url('Privilege/privilege_log'); ?>" target="main-frame">管理员日志</a></li>
            <li class="menu-item"><a href="<?php echo url('Privilege/role_list'); ?>" target="main-frame">角色管理</a></li>
						<li class="menu-item"><a href="<?php echo url('Privilege/node_list'); ?>" target="main-frame">权限列表</a></li>
					</ul>
				</li>
			</ul>
		</div>
...
function toggleCollapse()
{
  ...
  collapse = !collapse;
  document.getElementById('toggleImg').src = collapse ? '/static/admin/images/menu_minus.gif' : '/static/admin/images/menu_plus.gif';
