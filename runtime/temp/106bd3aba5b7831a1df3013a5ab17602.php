<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"F:\web\WWW\three_shop\public/../application/admin\view\privilege\Privilege_log.html";i:1524471486;}*/ ?>
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <td width="20%" align="center"><span>2018-04-23 09:56:46</span></td>
    <td width="15%" align="left"><span>127.0.0.1</span></td>
    <td width="40%" align="left"><span>编辑会员等级: vip</span></td>
  </tr>
    <tr>
    <td width="10%"><span><input name="checkboxes[]" type="checkbox" value="464" />464</span></td>
    <td width="15%" class="first-cell"><span>admin</span></td>
    <td width="20%" align="center"><span>2018-04-23 09:56:43</span></td>
    <td width="15%" align="left"><span>127.0.0.1</span></td>
    <td width="40%" align="left"><span>编辑会员等级: 注册用户</span></td>
  </tr>
    <tr>
    ...
    <tr>
    <td width="10%"><span><input name="checkboxes[]" type="checkbox" value="455" />455</span></td>
    <td width="15%" class="first-cell"><span>admin</span></td>
    <td width="20%" align="center"><span>2009-06-17 15:09:05</span></td>
    <td width="15%" align="left"><span>0.0.0.0</span></td>
    <td width="40%" align="left"><span>编辑商品: 诺基亚E66</span></td>
  </tr>
    <tr>
    <td width="10%"><span><input name="checkboxes[]" type="checkbox" value="454" />454</span></td>
    <td width="15%" class="first-cell"><span>admin</span></td>
    <td width="20%" align="center"><span>2009-06-17 15:06:49</span></td>
    <td width="15%" align="left"><span>0.0.0.0</span></td>
    <td width="40%" align="left"><span>编辑商品: 索爱C702c</span></td>
  </tr>
    <tr>
    <td width="10%"><span><input name="checkboxes[]" type="checkbox" value="453" />453</span></td>
    <td width="15%" class="first-cell"><span>admin</span></td>
    <td width="20%" align="center"><span>2009-06-17 15:04:27</span></td>
    <td width="15%" align="left"><span>0.0.0.0</span></td>
    <td width="40%" align="left"><span>回收商品: 摩托罗拉A810</span></td>
  </tr>
    <tr>
    <td width="10%"><span><input name="checkboxes[]" type="checkbox" value="452" />452</span></td>
    <td width="15%" class="first-cell"><span>admin</span></td>
    <td width="20%" align="center"><span>2009-06-17 15:02:49</span></td>
    <td width="15%" align="left"><span>0.0.0.0</span></td>
    <td width="40%" align="left"><span>编辑商品: 诺基亚5320 XpressMusic</span></td>
  </tr>
    <tr>
    <td width="10%"><span><input name="checkboxes[]" type="checkbox" value="451" />451</span></td>
    <td width="15%" class="first-cell"><span>admin</span></td>
    <td width="20%" align="center"><span>2009-06-17 15:00:18</span></td>
    <td width="15%" align="left"><span>0.0.0.0</span></td>
    <td width="40%" align="left"><span>编辑商品: 诺基亚5800XM</span></td>
  </tr>
    <tr>
